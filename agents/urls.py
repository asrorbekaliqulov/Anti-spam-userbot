...
urlpatterns = [
    ...
    path("join-events/", views.join_events_page, name="join_events"),
    path("strikes/", views.strikes_page, name="strikes"),
    # json api
    ...
    path("api/join-events/", views.api_join_events, name="api_join_events"),
